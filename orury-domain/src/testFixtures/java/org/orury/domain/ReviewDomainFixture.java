...
public class ReviewDomainFixture {
    ...
    public static class TestReview {
        ...
        private @Builder.Default int wantToGoCount = 0;
        private @Builder.Default int helpedCount = 1;
        private @Builder.Default int greatCount = 2;
        private @Builder.Default int funnyCount = 3;
    ...
    public static class TestReviewDto {
        ...
        private @Builder.Default int wantToGoCount = 1;
        private @Builder.Default int helpedCount = 2;
        private @Builder.Default int greatCount = 3;
        private @Builder.Default int funnyCount = 4;
